...
class KelompokPressureScreen extends StatefulWidget {
  const KelompokPressureScreen({super.key});

  @override
  State<KelompokPressureScreen> createState() => _KelompokPressureScreenState();
}

class _KelompokPressureScreenState extends State<KelompokPressureScreen> {
  late Future<List<dynamic>> listKelompokPressure;
  ...
  Future<List<dynamic>> fetchData(String id) async {
    ...
    try {
      ...
      Uri url = Uri.parse('${baseUrl}getKelompokPressureByInstalasi');
      ...
      body: BlocBuilder<InstalasiCubit, InstalasiState>(
        builder: (context, state) {
          if (state is InstalasiSuccess && state.selectedInstalasi != null) {
            listKelompokPressure = fetchData(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder<List<dynamic>>(
                        future:
                            listKelompokPressure, // Provide the future to FutureBuilder
                              ...
                              items:
                                  ...
                                  >((item) {
                                    return DropdownMenuItem<dynamic>(
                                      value:
                                          item['id_klp_press_gab'], // Adjust the key based on your data structure
                                      child: Text(
                                        item['nama_klp_press_gab'],
