...
class PressureScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    pressureCubit.fetchData(idKelompokPressure: idKelompok);
    String? selectedJam;
    String? selectedTanggal;
    String? selectedInstalasi;
    List<String> idPressure = [];
            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  BlocConsumer<PressureCubit, PressureState>(
                    bloc: pressureCubit,
                    listener: (context, state) {
                      if (state is PressureSuccessInsert) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Data berhasil disimpan!')),
                        );
                        Navigator.of(context).pop();
                      } else if (state is PressureError) {
                        ScaffoldMessenger.of(context).showSnackBar(
                    ...
                    builder: (context, state) {
                      if (state is PressureSuccess) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            idPressure.add(pressure.idPressGab!);
                            return Padding(
                      ...
                      } else if (state is PressureLoading) {
                        return Center(child: CircularProgressIndicator());
                      } else if (state is PressureError) {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      pressureCubit.simpan(
                        idKelompokPressure: idKelompok,
                        pressureList: pressureList,
                        jam: selectedJam,
                        tanggal: selectedTanggal,
                        idPressure: idPressure,
                      );
                    },
                    child: Text("SIMPAN"),
                  ),
