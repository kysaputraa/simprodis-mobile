...
class KelompokReservoirScreen extends StatefulWidget {
  const KelompokReservoirScreen({super.key});

  @override
  State<KelompokReservoirScreen> createState() =>
      _KelompokReservoirScreenState();
}

class _KelompokReservoirScreenState extends State<KelompokReservoirScreen> {
  late Future<List<dynamic>> listKelompokReservoir;
  ...
  Future<List<dynamic>> fetchData(String id) async {
    ...
    try {
      ...
      Uri url = Uri.parse('${baseUrl}getKelompokReservoirByInstalasi');
      ...
      body: BlocBuilder<InstalasiCubit, InstalasiState>(
        builder: (context, state) {
          if (state is InstalasiSuccess && state.selectedInstalasi != null) {
            listKelompokReservoir = fetchData(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder<List<dynamic>>(
                        future:
                            listKelompokReservoir, // Provide the future to FutureBuilder
                              ...
                              items:
                                  ...
                                  >((item) {
                                    return DropdownMenuItem<dynamic>(
                                      value:
                                          item['id_klp_reservoir'], // Adjust the key based on your data structure
                                      child: Text(
                                        item['nama_klp_reservoir'],
